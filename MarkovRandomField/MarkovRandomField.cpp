...
//void MarkovRandomField::calcSpatialFilter(){
...
//}
float* MarkovRandomField::getFiltered_Device()const{
...
void MarkovRandomField::visualize(float* depth_host){
...
void MarkovRandomField::getRGB(float ratio, cv::Vec3b& color){
